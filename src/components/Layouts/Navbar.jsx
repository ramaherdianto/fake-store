    ...
    return (
        <nav className='p-5 w-full bg-blue-500'>
            <div className='flex flex-col sm:flex-row max-w-7xl w-full items-center justify-between mx-auto gap-8'>
                ...
                <div className='flex justify-center items-center flex-wrap gap-4 gap-y-8'>
                    <div className='flex items-center justify-center gap-4'>
                        ...
                        <div className='px-2 py-[5px] text-slate-700 bg-slate-100 font-bold rounded'>
                            ${' '}
                            {total.toLocaleString('en-EN', { styles: 'currency', currency: 'USD' })}
                        </div>
                    </div>
                    <div className='flex items-center gap-4'>
